...
TestDraft3 = DRAFT3.to_unittest_testcase(
    ...
    skip=lambda test: (
        ...
        or skip(
            ...
            subject="ref",
            valid=False,
            case_description=("$ref prevents a sibling id from changing the base uri"),
        )(test)
    ),
)
...
TestDraft201909 = DRAFT201909.to_unittest_testcase(
    ...
    skip=lambda test: (
        ...
        or skip(
            message="recursiveRef support isn't working yet.",
            subject="recursiveRef",
            case_description=("multiple dynamic paths to the $recursiveRef keyword"),
        ...
        or skip(
            message="recursiveRef support isn't working yet.",
            subject="id",
            case_description=("Invalid use of fragments in location-independent $id"),
        )(test)
        or skip(
