...
try:
    ...
    from typing_extensions import (
        _TypedDictMeta as _PxTypedDictMeta,  # type: ignore[attr-defined]
    )
...
def build_object_type(properties=None, required=None, description=None, **kwargs):
    schema = {"type": "object"}
    if description:
...
class ComponentRegistry:
    ...
    def __contains__(self, component):
        ...
        registry_class = (
            query_obj if inspect.isclass(registry_obj) else registry_obj.__class__
        )
...
def load_enum_name_overrides():
    ...
    for name, choices in spectacular_settings.ENUM_NAME_OVERRIDES.items():
        ...
        hashable_values = [
            value for value, _ in normalized_choices if value not in ["", None]
        ]
