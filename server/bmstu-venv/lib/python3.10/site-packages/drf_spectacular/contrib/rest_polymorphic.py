...
class PolymorphicSerializerExtension(OpenApiSerializerExtension):
    ...
    def build_typed_component(
        self, auto_schema, component, resource_type_field_name, patched
    ):
        if spectacular_settings.COMPONENT_SPLIT_REQUEST and component.name.endswith(
            "Request"
        ):
