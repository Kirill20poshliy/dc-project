...
class OpenApiAuthenticationExtension(
    OpenApiGeneratorExtension["OpenApiAuthenticationExtension"]
):
    """
...
class OpenApiSerializerExtension(
    OpenApiGeneratorExtension["OpenApiSerializerExtension"]
):
    """
...
class OpenApiSerializerFieldExtension(
    OpenApiGeneratorExtension["OpenApiSerializerFieldExtension"]
):
    """
