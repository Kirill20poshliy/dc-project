...
class SpectacularAPIView(APIView):
    ...
    def _get_version_parameter(self, request):
        ...
        if (
            not api_settings.ALLOWED_VERSIONS
            or version in api_settings.ALLOWED_VERSIONS
        ):
            return version
        return None
    ...
    def get(self, request, *args, **kwargs):
        return Response(
            data={
                ...
                "swagger_ui_standalone": self._swagger_ui_resource(
        ...
        if request.GET.get("script") is not None:
            ...
            return Response(
                data={
                    "title": self.title,
                    "swagger_ui_css": self._swagger_ui_resource("swagger-ui.css"),
                    "swagger_ui_bundle": self._swagger_ui_resource(
...
class SpectacularSwaggerOauthRedirectView(RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        return (
            _get_sidecar_url("swagger-ui-dist/oauth2-redirect.html")
            + "?"
