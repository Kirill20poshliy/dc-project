...
def pmap(
    initial: Union[Mapping[KT, VT], Iterable[Tuple[KT, VT]]] = {}, pre_size: int = 0
) -> PMap[KT, VT]: ...
...
def field(
    ...
    invariant: Callable[[Any], Union[Invariant, Iterable[Invariant]]] = lambda _: (
        True,
        None,
    ),
    initial: Any = object(),
...
def pdeque(
    iterable: Optional[Iterable[T]] = None, maxlen: Optional[int] = None
) -> PDeque[T]: ...
